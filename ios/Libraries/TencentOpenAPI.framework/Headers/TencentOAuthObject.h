...
@end
#ifdef QQ_OPEN_SDK_GAME
#pragma mark -
#pragma mark game guild

/**
 * \brief 公会相关请求参数
 *
 */
@interface TCGuildBaseDic : TCAPIRequest
@property (nonatomic, retain) TCRequiredStr paramGuildId;   //公会Id
@property (nonatomic, retain) TCRequiredStr paramZoneId;    //分区Id
@property (nonatomic, retain) TCRequiredStr paramRoleId;    //角色Id
@end
 ...
 *
 */
@interface TCGuildQueryBindStateDic : TCGuildBaseDic
 ...
 * \note 不用释放，返回的对象是自动释放的
 */
+ (TCGuildQueryBindStateDic *) dictionary;
 ...
 *
 */
@interface TCGuildUnBindDic : TCGuildBaseDic
 ...
 *
 */
@interface TCGuildQueryMemberRelationDic : TCGuildBaseDic
 ...
 * \note 不用释放，返回的对象是自动释放的
 */
+ (TCGuildQueryMemberRelationDic *) dictionary;
 ...
 *
 */
@interface TCGuildJoinGroupDic : TCGuildBaseDic
 ...
 * \note 不用释放，返回的对象是自动释放的
 */
+ (TCGuildJoinGroupDic *) dictionary;
 ...
 *
 */
@interface TCGuildBindGroupDic : TCGuildBaseDic
 ...
 * \note 不用释放，返回的对象是自动释放的
 */
+ (TCGuildBindGroupDic *) dictionary;

/**
 * 开放平台申请的appKey
 */
@property (nonatomic, retain) TCRequiredStr paramAppKey;
 ...
 *
 */
@interface TCGuildRspBaseInfo : NSObject

/**
 * 返回错误码
 *
 * \attention 需\ref GuildErrorCode
 */
@property (nonatomic) GuildErrorCode retCode;
 ...
 *
 */
@interface TCGuildRspQueryBindStateInfo : TCGuildRspBaseInfo
 ...
 *
 */
@interface TCGuildRspUnBindInfo : TCGuildRspBaseInfo

/**
 *
 * 返回结果， YES 解绑成功； NO，会有对应的retCode标明错误原因
 */
...
/**
 * \brief 用户openid和公会id对应的群是否有绑定关系
 *
 */
@interface TCGuildRspQueryMemberRelationInfo : TCGuildRspBaseInfo

/**
 *
 * 返回结果， YES 有绑定关系，retCode=0； NO，没有绑定关系,retcode=0 或 retCode !=0 标明错误原因
 */
@property (nonatomic) BOOL result;
 ...
 *
 */
@interface TCGuildRspJoinGroupInfo : TCGuildRspBaseInfo

/**
 *
 * 调用接口返回的错误码，非网络请求返回码 \ref QQApiSendResultCode
 */
@property (nonatomic) QQApiSendResultCode apiSendResultCode;
 ...
 *
 */
@interface TCGuildRspBindGroupInfo : TCGuildRspBaseInfo
